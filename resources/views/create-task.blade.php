            ...
            <div class="min-w-0 flex-1">
                <form action="{{ route('tasks.store') }}" method="POST">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-1">
                            <textarea name="description" id="description" rows="8" class="@error('description')border-red-300 @enderror block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="What is the description of your task?">{{ old('description') }}</textarea>
                            @error('description')
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-1">
                            <input type="datetime-local" name="due_date" id="due_date" min="{{ now()->format('Y-m-d\TH:i') }}" value="{{ old('due_date') }}" class="@error('due_date')border-red-300 @enderror block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="What is the name of your task?">
                            @error('due_date')
